...
SoftwareSerial Serial1(10, 9); //define software serial port name as Serial1 and define (D10 = RX, D9 = TX)
#include <Servo.h>. 
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
int inputdistance = 500; // set Distance to trigger the PWM Aux Switch in cm (change this to adjust trigger distance)Stop
int inputdistance1 = 600; // set Distance to trigger the PWM Aux Switch in cm (change this to adjust trigger distance)Steer
//--------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Servo myServoA;// Creates a servo object for controlling the Output PWM D3 (stop)
Servo myServoB;// Creates a servo object for controlling the output PWM D6 (steer)
...
void loop() {
 ...
 if (( ( ( ( dist ) < ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) > ( 100 ) ) ))
    {
     digitalWrite(11 , HIGH);  //Relay Pin condition
     myServoB.write( 30 );
     delay( 50 );
    }
 if (( ( ( ( dist ) > ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) > ( 100 ) ) ))
    {
     digitalWrite(11 , LOW);  //Relay Pin condition
     myServoB.write( 90 );
     //delay( 5 );
    }     
 if (( ( ( ( dist ) < ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) < ( 100 ) ) ))
 ...
 if (( ( ( ( dist ) < ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) > ( 100 ) ) ))
    {
     digitalWrite(12 , HIGH);  //Relay Pin condition
     myServoB.write( 150 );
     delay( 50 );
    }
  if (( ( ( ( dist ) > ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) > ( 100 ) ) ))
    {
     digitalWrite(12 , LOW);  //Relay Pin condition
     myServoB.write( 90 );
     //delay( 5 );
    }       
  if (( ( ( ( dist ) < ( inputdistance1 ) ) && ( ( dist ) > ( 5 ) ) ) && ( ( ( 5 *  ardublockUltrasonicSensorCodeAutoGeneratedReturnCM( 4 , 4 ) ) ) < ( 100 ) ) ))
